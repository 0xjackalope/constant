...
do
    ...
    opts="--listen 127.0.0.1:$PORT --discoverpeers --datadir data$i --generate --sealerprivatekey $KEY --wallet --walletpassphrase '12345678'" --testnet
    if [ $i != 1 ]
    then
        opts="--norpc --listen 127.0.0.1:$PORT --discoverpeers --datadir data$i --generate --sealerprivatekey $KEY " --testnet
    fi
