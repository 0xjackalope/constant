...
func (self *Engine) StartSealer(sealerKeySet cashec.KeySet) {
	...
	Logger.log.Info("Starting sealer with public key address(base58check.encode): " + base58.Base58Check{}.Encode(self.config.ValidatorKeySet.PaymentAddress.Pk, byte(0x00)))
...
func (self *Engine) createBlock() (*blockchain.Block, error) {
	...
	newblock.Block.BlockProducer = base58.Base58Check{}.Encode(self.config.ValidatorKeySet.PaymentAddress.Pk, byte(0x00))
