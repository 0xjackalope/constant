...
func (self *Engine) OnRequestSign(msgBlock *wire.MessageRequestBlockSign) {
	...
	if err != nil {
		invalidBlockMsg := &wire.MessageInvalidBlock{
			...
			Validator: base58.Base58Check{}.Encode(self.config.ValidatorKeySet.PaymentAddress.PubKey, byte(0x00)),
		}
...
func (self *Engine) OnRequestSwap(msg *wire.MessageRequestSwap) {
	...
	senderID := base58.Base58Check{}.Encode(self.config.ValidatorKeySet.PaymentAddress.PubKey, byte(0x00))
